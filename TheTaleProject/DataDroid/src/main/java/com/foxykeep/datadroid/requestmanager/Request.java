...
public final class Request implements Parcelable {
    ...
    /**
     * Set whether the data returned from the {@link com.foxykeep.datadroid.service.RequestService} must be cached in memory or
     * not.
     *
     * @param enabled Whether the data returned from the {@link com.foxykeep.datadroid.service.RequestService} must be cached in
     *            memory or not.
     */
    ...
    /**
     * Return whether the data returned from the {@link com.foxykeep.datadroid.service.RequestService} must be cached in memory or
     * not.
     *
     * @return Whether the data returned from the {@link com.foxykeep.datadroid.service.RequestService} must be cached in memory or
     *         not.
